...
public class NotesList extends ListActivity implements SearchView.OnQueryTextListener {
     ...
     */
    /**
     * search view using search note by title
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = managedQuery(
                ...
                null,                             // No where clause, return all
                // records.
        ...
        String[] dateColumns = {NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE};
...
//        searchView=(SearchView) menu.findItem(R.id.search);
        ...
        searchView.setQueryHint("please input the title");
    ...
    public boolean onQueryTextChange(String s) {
        ...
        if (!s.isEmpty()) {
           cursor = managedQuery(
                    ...
                    new String[]{s},                             // No where clause, therefore no where column values.
                    NotePad.Notes.DEFAULT_SORT_ORDER  // Use the default sort order.
            );
        }else {
           cursor = managedQuery(
